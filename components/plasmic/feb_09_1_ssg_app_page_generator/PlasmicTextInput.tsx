...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: fPgRnOykqaZB/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__mdoRb)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__ylCcs)}
              role={"img"}
            />
          ),
